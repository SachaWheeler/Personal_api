...
error_reporting(0);
if(file_exists("/home/swheeler/public_html/globalFunctions.php"))
    include_once("/home/swheeler/public_html/globalFunctions.php");
...
class Location extends BaseClass{
    ...
    public function saveSosumi($device){
        $state_file = "/home/swheeler/public_html/home/iphone/state.txt";
        $time = array();
        $time['timestamp'] = time();
        $time['data'] = $device;

        // write it back
        $myfile = fopen($state_file, "w") or die("Unable to open state file!");
