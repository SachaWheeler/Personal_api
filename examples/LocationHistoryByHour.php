<?php
	...
	$history = new SimpleXMLElement($loc->historybyhour("xml"));
...
<html>
	...
	<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCw8NquQ8hadIeOFJO0cLD0S_emIkJME4A&sensor=false"></script>
    <script>
var map;
function initialize() {
  var mapOptions = {
...
<?php
	foreach($history as $place){
		if($x++) echo ",\n";
		echo "\t\t", "['", addslashes($place->street_addr), "', '", $place->latitude, "', '", $place->longitude, "']";
	}
	echo "\n";
?>
    ];
